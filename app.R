...
ui <- fluidPage(
  ...
  div(class = "footer-text",
      ...
      br(),
      "注意事項：", br(),
      "本ゲームは，1980年代後半に『週刊少年ジャンプ』の読者投稿コーナー「ジャンプ放送局」にて行われた「JBSクエスト」へのリスペクトを込めて制作された，ファンによる非公式の二次創作（トリビュート作品）です．", br(),
      ...
      "データの引用について：モード1で登場するキャラクター名およびパラメータ等のデータは，歴史的な記録を振り返る目的で，当時の誌面（『週刊少年ジャンプ』1989年43号～45号，1990年33号～35号）より引用しています．"
  )
)
