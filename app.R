...
ui <- fluidPage(
  ...
  div(class = "description-text",
      ...
      "注意事項：", "JBSクエストのソースコードはマル秘なので，本ゲームはJBSクエストを完全再現したものではありません．本ゲームは，製作者がR言語で独自に作成したものです．", tags$a(href="https://github.com/mtakahashi123/jbs-quest-live", "本ゲームのソースコード"), br(),
